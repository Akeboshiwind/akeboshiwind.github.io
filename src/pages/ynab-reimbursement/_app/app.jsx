...
const App = ({ historyUrl }) => {
  ...
  const [accounts, setAccounts] = useLocalStorage('accounts', [], { prefix: CONFIG_PREFIX });
  const [categories, setCategories] = useLocalStorage('categories', [], { prefix: CONFIG_PREFIX });
  const [categoryGroups, setCategoryGroups] = useLocalStorage('categoryGroups', [], { prefix: CONFIG_PREFIX });
  const [transactions, setTransactions] = useState([]);
  const [availableMonths, setAvailableMonths] = useLocalStorage('availableMonths', [], { prefix: CONFIG_PREFIX });
  const [accountTypes, setAccountTypes] = useLocalStorage('accountTypes', {}, { prefix: CONFIG_PREFIX });
  const [categoryTypes, setCategoryTypes] = useLocalStorage('categoryTypes', {}, { prefix: CONFIG_PREFIX });
  const [categoryGroupTypes, setCategoryGroupTypes] = useLocalStorage('categoryGroupTypes', {}, { prefix: CONFIG_PREFIX });
