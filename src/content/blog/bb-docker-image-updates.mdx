...
> **Note:** I actually ran it via docker rather than install it: `docker container run -i --rm ghcr.io/regclient/regctl:latest tag ls ubuntu`
...
<CodeBlock filename="src/regctl.clj">
...
<CodeBlock filename="src/semver.clj">
...
<CodeBlock filename="src/docker.clj">
...
<CodeBlock filename="src/core.clj">
